                            ...
                            <div class="card-body">
                                <a href="./index.php" class="text-nowrap logo-img text-center d-block mb-5 w-100">
                                    ...
                                    <form method="POST" action="register_submit.php">
                                        ...
                                        <div class="mb-3">
    <label for="positionSelect" class="form-label">ตำแหน่ง</label>
...
<div class="mb-4">
    <label for="organizeSelect" class="form-label">องค์กร</label>
    <select class="form-select" name="organize" id="organizeSelect">
...
<script>
  ...
  async function fetchData(url, elementId) {
    try {
      ...
      selectElement.innerHTML = '<option value="">เลือก...</option>'; // เคลียร์ตัวเลือกเก่า

      // ทำการเพิ่มตัวเลือกจากข้อมูลที่ได้จาก API
      data.forEach(item => {
        const option = document.createElement('option');
        option.value = item.name;  // หรือใช้ field ที่ตรงกับค่าของคุณ
        option.textContent = item.name;  // หรือ field ที่ใช้แสดงชื่อ
  ...
  fetchData('https://invoice.nekoth.com/API.php/listPosition', 'positionSelect');  // เปลี่ยน URL เป็น API ของตำแหน่ง
  fetchData('https://invoice.nekoth.com/API.php/listOrganize', 'organizeSelect');  // เปลี่ยน URL เป็น API ขององค์กร
</script>
</html>